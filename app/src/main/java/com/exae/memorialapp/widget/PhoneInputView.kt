...
class PhoneInputView : RelativeLayout {
    ...
    private fun initView(){
        val contentView = LayoutInflater.from(context).inflate(R.layout.layout_phone_input_view, this)
        ...
        setHintText(context.getString(R.string.code_phone_edt_tips))
