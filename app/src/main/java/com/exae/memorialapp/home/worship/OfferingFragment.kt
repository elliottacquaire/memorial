...
import com.exae.memorialapp.databinding.FragmentOfferingBinding
 ...
 * Use the [OfferingFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
@AndroidEntryPoint
class OfferingFragment : CoreFragment(R.layout.fragment_offering) {
    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null
    private var memorialNo: Int? = -1

    private var _binding: FragmentOfferingBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentOfferingBinding.inflate(inflater, container, false)
        return binding.root
    }
